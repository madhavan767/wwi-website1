...
// CORS Configuration satisfying credentials: 'include' (Exact requesting origin, NO wildcard '*')
const allowedOrigins = [
  'https://wwi-website1.vercel.app',
  'https://wwi.org.in',
  'https://www.wwi.org.in',
  'http://localhost:5173',
  'http://localhost:3000',
...
const corsOptions = {
  origin: (origin, callback) => {
    if (!origin || allowedOrigins.includes(origin) || origin.endsWith('.vercel.app') || origin.includes('wwi.org.in')) {
